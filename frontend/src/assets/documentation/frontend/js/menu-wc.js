...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">infinitag documentation</a>
                </li>
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-8bc83dad1e5b86921f179d619b7a84f8"' :
                                            ...
                                            <li class="link">
                                                <a href="components/DocumentViewTableComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DocumentViewTableComponent</a>
                                            </li>
                                            <li class="link">
